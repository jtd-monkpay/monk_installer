...
read -p "Enter the domain you want to use for Monk (example: monkshop.dev, demo.monkshop.dev): " domain
...
# Download Paymenter
curl -Lo paymenter.tar.gz https://github.com/jtd-monkpay/monkpay/releases/latest/download/paymenter.tar.gz
tar -xzvf paymenter.tar.gz
chmod -R 755 storage/* bootstrap/cache/

# Create user and database in MySQL
    read -p "Enter the database name (press Enter to use 'monkpay'): " db_name
    db_name=${db_name:-monkpay}
    read -p "Enter the database username (press Enter to use 'monkpay'): " db_user
    db_user=${db_user:-monkpay}
